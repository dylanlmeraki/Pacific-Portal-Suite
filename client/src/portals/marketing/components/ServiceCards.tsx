...
export const colorMap = {
  ...
  bluecyan: {
    ...
    gradient: "linear-gradient(to right, #22d3ee, #5eead4, #86efac)",
  ...
  cyan: {
    ...
    shadowColor: "rgba(13,148,136,0.22)",
    gradient: "linear-gradient(to right, #86efac, #2dd4bf, #06b6d4)",
  ...
  cyanteal: {
    ...
    gradient: "linear-gradient(to right, #06b6d4, #0ea5e9, #3b82f6)",
